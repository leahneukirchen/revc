...
ifdef shell-script-names
	for f in $(shell-script-names) ; do test ! -e  $(cgi-install-dir)/$$f || rm $(cgi-install-dir)/$$f; done
...
clean-install-shell-cgi-scripts:
	test ! -e Installed-shell-cgi-scripts || rm Installed-shell-cgi-scripts

endif

# arch-tag: Tom Lord Mon Apr 29 23:38:43 2002 (Makefiles/install-shell-cgi-scripts.mk)
#
