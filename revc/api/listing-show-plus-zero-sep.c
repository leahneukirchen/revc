...
int
revc_listing_show_plus_zero_sep (const t_uchar * const errname,
...
/* arch-tag: Tom Lord Thu Jun 23 18:03:38 2005 (api/listing-show-plus-zero-sep.c)
 */
