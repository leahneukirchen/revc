...
#include "revc/mains/name-main.h"

const t_uchar * const revc_manifest_usage = "[-0|--null] [dir]";

int
revc_name_main (int argc, char ** argv)
{
  ...
  if (!list_remain)
    {
      revc_error (errname, "tree has no ancestry\n");
      goto bail;
    }
...
/* arch-tag: Tom Lord Mon Jun 27 13:16:51 2005 (mains/name-main.c)
 */
