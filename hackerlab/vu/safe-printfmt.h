...
extern void safe_printfmt (int fd, const char * fmt, ...) __attribute__((format (printf, 2, 3)));
     

/* automatically generated __STDC__ prototypes */
extern void safe_printfmt (int fd, const char * fmt, ...);
extern void safe_printfmt_va_list (int fd,
                                   const char * fmt,
                                   va_list ap);
